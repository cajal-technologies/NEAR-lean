...
At Milestone 4, the repository implements a proof-friendly abstract sandbox. It
...
- execute blocks, shards, promise-and, promise yield/resume, or arbitrary WASM;
...
Milestone 1 kernel, Milestone 2 sandbox, Milestone 3 differential, and Milestone 4
receipt entries record implementation, test, and proof evidence; later features
remain `unsupported`.
